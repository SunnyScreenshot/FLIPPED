...
#define BB_PARA_MARGIN_HOR 10 * 2      // 底部 bar； 选取的最小边框. 左右间距
#define BB_PARA_MARGIN_VER 8 * 2       // 底部 bar； 选取的最小边框. 上下间距  --> 取色盘 不显示时
#define BB_PARA_MARGIN_VER_HAS_COLOR_PARA 6 * 2  // 底部 bar； 选取的最小边框. 上下间距  -->  取色盘 显示时，由于非等距离， 故要小一点
