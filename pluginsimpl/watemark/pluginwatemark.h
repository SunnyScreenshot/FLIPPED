#ifndef PLUGINWATEMARK_H
#define PLUGINWATEMARK_H

#include <QWidget>
#include "../../src/pluginsinterface/iplugininterface.h"

class PluginWateMark : public QObject, IPluginInterface  // 必须多继承自 QObject 和抽象类；
{
    Q_OBJECT
...
public:
    explicit PluginWateMark(QObject *parent = nullptr);
